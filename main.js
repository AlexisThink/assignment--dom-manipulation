...
document.querySelector("#double button").addEventListener('click',function(){
  // TASK #2
  var currenValue = document.getElementById('compoundInvestment');
  var number = parseInt(currenValue.textContent);
  var result = 0;

  result += number*2;

  document.getElementById('compoundInvestment').textContent = result;
})
